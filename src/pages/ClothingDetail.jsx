        ...
        <div className="bg-white">
            ...
            <div className="pt-4 px-6">
                <div className="text-sm flex items-center flex-wrap space-x-1">
                    <Link to="/product/clothing" className="hover:underline font-medium text-gray-400">
                        Quần áo
                    </Link>
                    ...
                    <div className="w-full bg-white p-8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                            {relatedProducts.map((relatedProduct) => (
                                <Link key={relatedProduct.id} to={`/product/clothing/${relatedProduct.id}`} className="block">
